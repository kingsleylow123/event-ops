...
const PUBLIC_PATHS = ['/login', '/auth/callback', '/pending', '/reset-password', '/api/notify-signup', '/checkin', '/api/checkin', '/meeting-checkin', '/api/meeting-checkin', '/survey', '/api/survey', '/briefing', '/api/telegram', '/api/affiliates/cron']
