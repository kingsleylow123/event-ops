  ...
  return (
    <div className="space-y-6">
      ...
      {loadingReport || !report ? (
        ...
        <>
          <div className="text-xs text-zinc-500 bg-[#0f0f0f] border border-zinc-800 rounded-lg px-3 py-2">
            💸 See full payout summary + bank details in the <a href="/payout" className="text-amber-400 hover:underline">Payout</a> tab.
          </div>
